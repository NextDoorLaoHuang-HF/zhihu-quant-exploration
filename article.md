...
>
> **填权（分红后股价回升）的超额收益从-2.3%修正为+2.79%。** 之前用股票自己跟自己比来算超额，等于没有参照系。改用大盘指数做参照后，分红后60天平均能多赚2.79%——方向反过来了，但幅度很小，专门靠这个赚钱不现实。
>
> **可转债策略样本大幅扩充。** 从4只扩充到1006只（含682只已退出券），重新跑了回测。策略年化6.62%，夏普0.59。
>
